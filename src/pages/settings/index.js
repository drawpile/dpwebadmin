		...
		if(settings !== null) {
			...
			inputGrid = <InputGrid>
				...
				<Field>
					...
					<CheckboxInput label="Automatically allow WebSockets on passworded sessions, disallow on non-passworded ones" enabled={settings['passwordDependentWebSession'] !== undefined} {...vprops('passwordDependentWebSession')} />
				</Field>
